...
export default function BarChart() {
	...
	const oneWeekDotsHours = useSelector((state) => state.oneWeekDots); //今週の勉強時間reduxVer
	const lastWeekDotsHours = useSelector((state) => state.lastWeekDots); //前週の勉強時間reduxVer
	// console.log(filledWeek2);
	// console.log(lastWeekDotsHours);
